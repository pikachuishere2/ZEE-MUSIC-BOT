...
from ZeeMusic.core.call import Zee, autoend, counter
from ZeeMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await Zee.call_listeners(chat_id))
