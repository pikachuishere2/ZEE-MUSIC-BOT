...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("ZeeMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("ZeeMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("ZeeMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("ZeeMusic/assets/play_icons.png")
