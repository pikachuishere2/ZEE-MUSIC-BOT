...
async def gen_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("ZeeMusic/assets/font2.ttf", 30)
        ...
        if is_live:
            live_font = ImageFont.truetype("ZeeMusic/assets/font2.ttf", 22)
    ...
    # Icons
    try:
        icons_path = "ZeeMusic/assets/play_icons.png"
